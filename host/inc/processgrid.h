...
#ifndef _WIN32
	char*  grid_file_path;	  // Added to store the full director of the grid file
	char*  grid_file_name;	  // Added to store the full path of the grid file
#else
	char  grid_file_path[2*_MAX_DIR];	  // Added to store the full director of the grid file
	char  grid_file_name[2*_MAX_DIR];	  // Added to store the full path of the grid file
#endif
